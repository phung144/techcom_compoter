                        ...
                        <div className="offcanvas__content">
                            <div className="offcanvas__top mb-5 d-flex justify-content-between align-items-center">
                                <div className="offcanvas__logo">
                                    <a href="index.html">
                                        <img src="./src/assets/img/logo/logo.png" alt="logsadsado-img" />
                                    </a>
                                </div>
                                    ...
                                    <div className="header-left">
                                        <div className="logo">
                                            <a href="/" className="header-logo">
                                                <img src="../src/assets/img/logo/logo.png" width="25%" alt="lưqewqogo-img" />
                                            </a>
                                        </div>
                            ...
                            <div className="row">
                                <div className="col-6 col-md-6 col-lg-10 col-xl-8 col-xxl-10">
                                    <div className="header-left">
                                        <div className="logo">
                                            <a href="/" className="header-logo">
                                                <img src="/src/assets/img/logo/logo.png" width="25%" alt="logdsado-img" />
                                            </a>
                                        </div>
                                        <div className="mean__menu-wrapper">
                                            <div className="main-menu">
